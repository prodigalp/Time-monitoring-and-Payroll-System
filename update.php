...
<link rel="stylesheet" type="text/css" href="embelish/update_decor.css"></link>
</head>
<body>
	<form method="POST">
	<div id="wrap">
		<div id="head">Update Records</div>
		<div id="menu">
			<ul>
		...
		<div id="content">
			...
			<table>
				<tr>
					<td><input type="text" name="txtEmp" id="txtEmp" size="40" placeholder="Enter employee number to update">
			...
			?>
				<tr>
					<td>
						<a href="update_details.php?id=<?php echo $row['empnum'];?>" style="text-decoration:none;font-size:16px;" >
						<?php echo $row['empnum'];?>
						</a>
					</td>

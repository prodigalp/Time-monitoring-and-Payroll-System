...
<link rel="stylesheet" type="text/css" href="embelish/view_decor.css"></link>
</head>
<body>
	<form method="POST">
	<div id="wrap">
		...
		<div id="content">
			...
			<table>
				<tr>
					<td><input type="text" name="txtEmp" id="txtEmp" size="40" placeholder="Enter employee number to search">
			...
			<table>
				...
				<tr>
					<td><?php echo $cntr; ?></td>
					<td>
						<a style="text-decoration:none;font-size:16px;" href="details.php?id=<?php echo $row['empnum'] ?>" title="Click to see details">
						<?php echo $row['empnum']; ?>
						</a>
					</td>
			...
			<?php echo "<br><br><center>Result found:". "<b>".$cntr."</b>"?>
			</div>
